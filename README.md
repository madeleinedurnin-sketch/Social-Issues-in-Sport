...
*The relevant materials for each project are included in the specific folder. Each research question is listed below the heading for clairty surrounding the topic.*

# [Project 1: Audience Influence on Angel Reese vs Caitlin Clark Rivalry](Project-1/)
...
# [Project 2: The Legitimacy of the TGL League](Project-2/)
